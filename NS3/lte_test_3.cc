...
//WIFI Simulation
  ...
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (15.1)));
  ...
  echoClientHelper.SetAttribute ("MaxPackets", UintegerValue (Rx[0][0]));
  echoClientHelper.SetAttribute ("Interval", TimeValue (Seconds (0.1)));
  echoClientHelper.SetAttribute ("PacketSize", UintegerValue (1400));
  ApplicationContainer pingApps;

  // again using different start times to workaround Bug 388 and Bug 912
  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (10.1)));
  echoClientHelper.SetAttribute ("StopTime", TimeValue (Seconds (15.0)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (0)));

  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (15.1)));
  echoClientHelper.SetAttribute ("StopTime", TimeValue (Seconds (20.0)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (2)));
   ...
   AnimationInterface anim ("lte_test.xml"); // Mandatory
        ...
        {
          anim.UpdateNodeDescription (nodes.Get(i), "Nodes"); // Optional
          anim.UpdateNodeColor (nodes.Get(i), 255, 0, 255); // Coloração
        }
