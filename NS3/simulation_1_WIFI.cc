...
//Metodo Animation
        ...
        AnimationInterface anim ("simulation_1/wifi_flow/simulation_1_wifi.xml"); // Mandatory
        ...
        anim.EnableIpv4RouteTracking ("simulation_1/wifi_flow/routingtable-wireless.xml", Seconds (0), Seconds (5), Seconds (0.25)); //Optional
