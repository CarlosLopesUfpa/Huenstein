...
//Gerar animação
        AnimationInterface anim ("Master_Node/resultados_selecao/2_" + gp + "_master_node_sel.xml"); // Mandatory
        ...
        anim.EnableIpv4RouteTracking ("Master_Node/resultados_selecao/2_" + gp + "_master_node_sel_route.xml", Seconds (0), Seconds (5), Seconds (0.25)); //Optional
...
for(int i = 0; i<nAll; ++i)
{
  ...
  std::ofstream myfile ("Master_Node/resultados_selecao/2_1_"+gp+"_Point_Relay_Nodes.txt");
     std::cout << " " <<std::endl;
