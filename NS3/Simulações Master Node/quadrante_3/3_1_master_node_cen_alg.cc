...
// Obter Média da Simulação
 ...
 double DesJitter = 0;
  ...
  std::ofstream myfile ("Master_Node/centroide_Algoritmo/2_1_"+gp+"Results_cen_alg.csv");
  if (myfile.is_open())
  {
  ...
  std::ofstream con ("Master_Node/centroide_Algoritmo/2_1_"+gp+"_Conectados_Cen_Alg.txt");
