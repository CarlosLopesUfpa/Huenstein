...
//Gerar animação
        AnimationInterface anim ("Master_Node/centroide_Algoritmo/1_1_" + gp + "_master_node_cen_alg.xml"); // Mandatory
        ...
        anim.EnableIpv4RouteTracking ("Master_Node/centroide_Algoritmo/1_1_" + gp + "_master_node_cen_alg_route.xml", Seconds (0), Seconds (5), Seconds (0.25)); //Optional
...
// Obter Média da Simulação
 ...
 double DesJitter = 0;
  ...
  std::ofstream myfile ("Master_Node/centroide_Algoritmo/1_1_"+gp+"_Results_cen_alg.csv");
  if (myfile.is_open())
  {
  ...
  std::ofstream con ("Master_Node/centroide_Algoritmo/1_1_"+gp+"_Conectados_Cen_Alg.csv");
