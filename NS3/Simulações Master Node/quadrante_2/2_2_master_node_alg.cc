...
//Gerar animação
        AnimationInterface anim ("Master_Node/algoritmo/2_2_" + gp + "_master_node_alg.xml"); // Mandatory
        ...
        anim.EnableIpv4RouteTracking ("Master_Node/algoritmo/2_2_" + gp + "_master_node_alg_route.xml", Seconds (0), Seconds (5), Seconds (0.25)); //Optional
...
// Obter Média da Simulação
 ...
 double DesJitter = 0;
  ...
  std::cout << "Nó Selecionado "<< vet[0][0] <<std::endl;
    ...
    std::ofstream myfile ("Master_Node/algoritmo/2_2_"+gp+"_Results_Algoritmo.csv");
 ...
 if (myfile.is_open())
  ...
  std::ofstream con ("Master_Node/algoritmo/2_2_"+gp+"_Conectados_Alg.txt");
